...
def validate(args):
    ...
    if args.label == None:
        ...
        print('We suggest giving your plate a name. Otherwise, the heatmap title is not descriptive.')
...
if __name__ == "__main__":
    ...
    instance = BeadFinder(args.image_path, args.algorithm_name, args.label, args.image_registration, args.show_heatmap, args.output_dir)
